...
use AppBundle\Form\Client\ClientNewType;
use AppBundle\Form\Client\ClientEditType;
...
class ClientController extends Controller
{
    ...
    {
        $client = new Client();
        $form = $this->createForm('AppBundle\Form\Client\ClientNewType', $client);
    ...
    {
        $editForm = $this->createForm('AppBundle\Form\Client\ClientEditType', $client);
